fetch('https://dummyjson.com/products').then(response=>response.json()).then(data=>{
        ...
        col.innerHTML=`
                    ...
                    <div class="card" style="width:100%">
                        ...
                        <div class="card-body">
                           ...
                           <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal" data-id="${element.id}">View Product</button>
                        </div>
                    </div>
    ...
    document.querySelectorAll(".btn").forEach(btn=>{
        btn.addEventListener('click',(e)=>{
            ...
            ${product.price} <br> ${product.discountPercentage} <br>
            ${product.description}
